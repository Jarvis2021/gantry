...
class DockerProvider:
    ...
    def _wake_docker(self) -> Optional[DockerClient]:
        """
        ...
        try:
            if system == "Darwin":  # macOS
                ...
                if os.path.exists(default_path):
                    ...
                    console.print("[yellow][DOCKER] Docker Desktop not found in default location[/yellow]")
                    return None
            elif system == "Linux":
            ...
            with console.status("[yellow]Waiting for Docker Engine (up to 60s)...[/yellow]", spinner="clock"):
                for _ in range(60):
                    try:
